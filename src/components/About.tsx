          ...
          <div className="space-y-6 animate-fade-in">
            <div className="glass p-8 rounded-2xl">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Currently at <span className="text-primary font-semibold">Johnson & Johnson</span>, I build the enterprise assistant platform—an enterprise RAG system serving 140K+ employees with 10K-25K monthly queries. Using Claude/OpenAI APIs, Qdrant vector database, and production-grade observability.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
