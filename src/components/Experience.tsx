  ...
  const experiences = [
    {
      ...
      current: true,
      highlights: [
        'Building enterprise assistant—an enterprise RAG platform serving 140K+ employees with 10K-25K monthly queries using Qdrant, Claude/OpenAI APIs, and LangChain',
