  ...
  const experiences = [
    {
      ...
      current: false,
      highlights: [
        'Contributed to enterprise assistant, a production-scale RAG system serving ~140,000 internal users, supporting enterprise knowledge retrieval through document chunking, embedding generation, and vector indexing in Qdrant with role-based collection routing',
