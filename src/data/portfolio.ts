...
export const work: WorkItem[] = [
  { slug: 'enterprise-ai-quality', title: 'enterprise assistant — Production AI quality systems', summary: 'Evaluation, observability, failure triage, and cross-system analytics for an enterprise RAG assistant serving approximately 140,000 internal users.', category: 'Flagship systems', tags: ['LLMOps', 'RAG evaluation', 'Observability'], private: true, featured: true },
