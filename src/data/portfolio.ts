...
export const work: WorkItem[] = [
  ...
  { slug: 'saketh-learning', title: 'Systems-to-Inference Learning Roadmap', summary: 'A private learning control center for a nine-layer path from OS, networking, caching, Postgres, and queues to transformer execution, inference serving, and agent harnesses. Reads SakethWiki notes read-only as live evidence of progress; Python server, SQLite, Docker.', category: 'Developer tools', tags: ['Systems', 'Inference', 'SakethWiki'], private: true, updated: '2026-09-22' },
...
export const activity: ActivityItem[] = [
  { date: '2026-09-22', title: 'Built a systems-to-inference learning roadmap', summary: 'A local app that maps SakethWiki notes onto a nine-layer backend, inference, and agent-harness curriculum, including Backend from First Principles.' },
